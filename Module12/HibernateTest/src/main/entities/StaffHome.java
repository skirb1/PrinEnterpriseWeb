...
public class StaffHome {
	...
	public Staff findById(java.lang.Byte id) {
		...
		try {
			Staff instance = (Staff) sessionFactory.getCurrentSession().get("main.entities.Staff", id);
			if (instance == null) {
	...
	public List findByExample(Staff instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("main.entities.Staff")
