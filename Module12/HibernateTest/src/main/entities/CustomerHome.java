...
// Generated Aug 15, 2019 5:42:54 PM by Hibernate Tools 5.4.2.Final
...
public class CustomerHome {
	...
	public Customer findById(java.lang.Short id) {
		...
		try {
			Customer instance = (Customer) sessionFactory.getCurrentSession().get("main.entities.Customer", id);
			if (instance == null) {
	...
	public List findByExample(Customer instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("main.entities.Customer")
	...
	public List findAll() {
		...
		try {
			List results = sessionFactory.getCurrentSession().createQuery("from Customer").getResultList();
					//.createCriteria("main.entities.Customer")
					//.add(Example.create(instance)).list();
