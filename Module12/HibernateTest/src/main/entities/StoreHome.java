...
public class StoreHome {
	...
	public Store findById(java.lang.Byte id) {
		...
		try {
			Store instance = (Store) sessionFactory.getCurrentSession().get("main.entities.Store", id);
			if (instance == null) {
	...
	public List findByExample(Store instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("main.entities.Store")
