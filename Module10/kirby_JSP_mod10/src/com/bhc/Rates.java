...
public class Rates implements Serializable {
    ...
    public void calculateTotalCost() {
    	if(!isParticipantCountValid()) {
    		details = "Participant count must be at least 1 and no greater than 10";
    		cost = -0.01;
    	} else {
    		cost = (calculateCost() / 100.0) * participantCount;
    	}
    }
    ...
    private int calculateCost() {
    	if(!isDurationValid()) {
    		details = "Selected duration is not valid";
    		return -1;
    	}
    ...
    private boolean isParticipantCountValid() {
    ...
    public static void main(String[] argv) {
        ...
        rates.setDuration(7);
        System.out.println("duration was " + rates.getSelectedDuration());
